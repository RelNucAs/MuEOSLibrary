CXX      := g++ 
RFLAGS   := -std=c++17 -O3 -Did_test=2 -g -Wall -lm -Isrc/ #-Wpedantic
...
main: $(OBJ_FILES) eos_otf main.o
	$(CXX) -Did_test=2 $(RFLAGS) $(H5_INCLUDE) $(OBJ_FILES) $(OBJ_DIR)eos_assembled_otf.o main.o -o main $(H5_LIB) $(H5_FLAGS)
...
eos_interp: $(SRC_DIR)eos_species/eos_species.cpp
	$(CXX) -Did_test=2 $(RFLAGS) $(H5_INCLUDE) -c -o $(OBJ_DIR)eos_assembled_int.o $(SRC_DIR)eos_species/eos_species.cpp $(H5_LIB) $(H5_FLAGS)

eos_otf: $(SRC_DIR)eos_species/eos_species.cpp
	$(CXX) -Did_test=2 $(RFLAGS) $(H5_INCLUDE) -c -o $(OBJ_DIR)eos_assembled_otf.o $(SRC_DIR)eos_species/eos_species.cpp $(H5_LIB) $(H5_FLAGS)
...
data_plot: $(OBJ_FILES) eos_otf $(OUT_DIR)obj/generate_data_plot.o
	$(CXX) $(RFLAGS) $(H5_INCLUDE) $(OBJ_FILES) $(OBJ_DIR)eos_assembled_otf.o $(OUT_DIR)obj/generate_data_plot.o -o $(OUT_DIR)bin/generate_data_plot $(H5_LIB) $(H5_FLAGS)
	$(OUT_DIR)bin/generate_data_plot
...
number_nr_iter: $(OBJ_FILES) eos_otf $(TEST_DIR)obj/number_nr_iter.o
	$(CXX) $(RFLAGS) $(H5_INCLUDE) $(OBJ_FILES) $(OBJ_DIR)eos_assembled_otf.o $(TEST_DIR)obj/number_nr_iter.o -o $(TEST_DIR)bin/number_nr_iter $(H5_LIB) $(H5_FLAGS)
	$(TEST_DIR)bin/number_nr_iter > $(TEST_DIR)/number_nr_iter_muons.txt

test_eos_performance: $(OBJ_FILES) eos_otf $(TEST_DIR)obj/test_eos_performance.o
	$(CXX) $(RFLAGS) $(H5_INCLUDE) $(OBJ_FILES) $(OBJ_DIR)eos_assembled_otf.o $(TEST_DIR)obj/test_eos_performance.o -o $(TEST_DIR)bin/test_eos_performance $(H5_LIB) $(H5_FLAGS)
#	$(TEST_DIR)bin/test_eos_performance
