...
eos_interp: $(SRC_DIR)eos_species/eos_assembled.cpp
	$(CXX) -Did_test=1 $(RFLAGS) $(H5_INCLUDE) -c -o $(OBJ_DIR)eos_assembled_int $(SRC_DIR)eos_species/eos_assembled.cpp $(H5_LIB) $(H5_FLAGS)

eos_otf: $(SRC_DIR)eos_species/eos_assembled.cpp
	$(CXX) -Did_test=2 $(RFLAGS) $(H5_INCLUDE) -c -o $(OBJ_DIR)eos_assembled_otf $(SRC_DIR)eos_species/eos_assembled.cpp $(H5_LIB) $(H5_FLAGS)

output_table: $(OBJ_FILES) eos_otf $(OUT_DIR)obj/generate_output_table.o
	$(CXX) $(RFLAGS) $(H5_INCLUDE) $(OBJ_FILES) $(OBJ_DIR)eos_assembled_otf $(OUT_DIR)obj/generate_output_table.o -o $(OUT_DIR)bin/generate_output_table $(H5_LIB) $(H5_FLAGS)
	$(OUT_DIR)bin/generate_output_table

lep_table: $(OBJ_FILES) eos_otf $(OUT_DIR)obj/generate_lep_table.o
	$(CXX) $(RFLAGS) $(H5_INCLUDE) $(OBJ_FILES) $(OBJ_DIR)eos_assembled_otf $(OUT_DIR)obj/generate_lep_table.o -o $(OUT_DIR)bin/generate_lep_table $(H5_LIB) $(H5_FLAGS)
	$(OUT_DIR)bin/generate_lep_table

comparison_with_mu: $(OBJ_FILES) eos_otf $(TEST_DIR)obj/comparison_with_mu.o
	$(CXX) $(RFLAGS) $(H5_INCLUDE) $(OBJ_FILES) $(OBJ_DIR)eos_assembled_otf $(TEST_DIR)obj/comparison_with_mu.o -o $(TEST_DIR)bin/test_comparison_with_mu $(H5_LIB) $(H5_FLAGS)
	$(TEST_DIR)bin/test_comparison_with_mu

comparison_without_mu: $(OBJ_FILES) eos_otf $(TEST_DIR)obj/comparison_without_mu.o
	$(CXX) $(RFLAGS) $(H5_INCLUDE) $(OBJ_FILES) $(OBJ_DIR)eos_assembled_otf $(TEST_DIR)obj/comparison_without_mu.o -o $(TEST_DIR)bin/test_comparison_without_mu $(H5_LIB) $(H5_FLAGS)
	$(TEST_DIR)bin/test_comparison_without_mu

hist_comp_with_mu: $(OBJ_FILES) eos_otf $(TEST_DIR)obj/hist_comp_with_mu.o
	$(CXX) $(RFLAGS) $(H5_INCLUDE) $(OBJ_FILES) $(OBJ_DIR)eos_assembled_otf $(TEST_DIR)obj/hist_comp_with_mu.o -o $(TEST_DIR)bin/test_hist_comp_with_mu $(H5_LIB) $(H5_FLAGS)
