...
int main (){
	...
	const double nb = 0.16;    // fm-3
	const double T  = 10.;     // MeV
	double Y[2] = {0.1,0.01};   // #/baryons
	...
	const double e = MeV*1.e39*eos.Energy(nb, T, Y);
